...
import {getDate, getSubscribers, getLikes} from "../modules/functions";
import {authors} from "../modules/char";
                ...
                <div className="wrapper__box">
                    <div className="box__separation">
                        <div className="box__separation_media">
                            ...
                            <div className="media__photo"><img src={item.photo} /> </div>
                            ...
                            <div className="media__subscribers">
                                ...
                                <div className="media__subscribers_info">
                                    <div> {getSubscribers()} </div>
                                </div>
                            </div>
                        </div>
                        <div className="box__separation_info">
                            <div className="info__date"> {getDate()} </div>
                            <div className="info__image"> <img src={item.image} /> </div>
